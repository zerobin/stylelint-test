...
<template>
  <view class="share">
    <view>
      <mdm-button @click="getUserInfo" plain type="info">获取用户信息</mdm-button>
    </view>
    <mdm-button @click="openShareBox" type="primary">绘制海报</mdm-button>
...
<script setup lang="ts">
  ...
  const onShareAppMessage = () => {
    let title = '分享页面'
    let path = 'package-other/pages/share'
